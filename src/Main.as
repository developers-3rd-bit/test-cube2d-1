package
{
   ...
   public class Main extends Sprite
   {
      ...
      public function Main()
      {
         ...
         _vGroup.paddingLeft = 120;
         _vGroup.verticalGap = 7;
         _canvas.prepareElementAndPosition(_vGroup, 40, 10, 5, 5);
         
         _hGroup1 = new HalcyonHGroup(_vGroup, _vGroup.width, 210);
         _hGroup1.horizontalgap = 10;
         _vGroup.addChild(_hGroup1);
         
         _hGroup2 = new HalcyonHGroup(_vGroup, _vGroup.width, 210);
         _hGroup2.horizontalgap = 10;
         _vGroup.addChild(_hGroup2);
         
         _hGroup3 = new HalcyonHGroup(_vGroup, _vGroup.width, 210);
         _hGroup3.horizontalgap = 10;
      ...
      private function onAddButtonClick(event:Event):void
      {
         ...
         var view:View = new View(220, 200);
